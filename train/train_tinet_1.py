...
checkpoint_path = f'weights/tinet/best_model_cusin_{CUSTOM_CONV_LAYER_INDEX}.pth'
...
for epoch in range(NUM_EPOCHS):
    ...
    if val_acc > best_acc:
        best_acc = val_acc
        torch.save(model.state_dict(), f'weights/tinet/best_model_cusin_{CUSTOM_CONV_LAYER_INDEX}.pth')
